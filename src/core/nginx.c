...
main(int argc, char *const *argv)
{
    ...
    ngx_debug_init();
    printf("打印一些常量看看\n");
    // printf("NGX_DEBUG_PALLOC,%d\n",NGX_DEBUG_PALLOC);
        printf("NGX_MIN_POOL_SIZE,%lu\n",NGX_MIN_POOL_SIZE);  //112
        printf("sizeof(ngx_pool_large_t),%lu\n",sizeof(ngx_pool_large_t));  //112
        ...
        while (*p) {
            ...
            case 'c':
                ...
                if (argv[++i]) {
                    ...
                    printf("读取到的配置文件是%s",ngx_conf_file);
